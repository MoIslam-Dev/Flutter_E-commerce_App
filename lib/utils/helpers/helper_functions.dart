...
/// EHelperFunctions class provides a set of utility methods for various common operations in a Flutter application.
/// 
/// This class includes methods for:
/// - Retrieving colors based on string values.
/// - Displaying snack bars and alert dialogs.
/// - Navigating to different screens.
/// - Truncating text to a specified length.
/// - Checking if the application is in dark mode.
/// - Getting screen dimensions.
/// - Formatting dates.
/// - Removing duplicates from a list.
/// - Wrapping widgets into rows.
